...
require (
	github.com/GoogleCloudPlatform/opentelemetry-operations-collector v0.147.0
...
replace go.opentelemetry.io/collector/confmap/xconfmap => go.opentelemetry.io/collector/confmap/xconfmap v0.146.1
